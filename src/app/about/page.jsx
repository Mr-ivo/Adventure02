...
function page() {
  return (
    ...
    <div>
        ...
        <p>We love hearing from our readers Connect with us on Facebook to stay updated on our latest posts, share your own experiences, and join the conversation. Do not hesitate to reach out to us via <Link href="/contact">nzoggeivo@gmail.com</Link> if you have any questions or suggestions.</p>
