...
function page() {
  return (
    ...
    <div>
        ...
        <p className={styles.desc}>Get inspired, plan your next adventure, and immerse yourself in the rich tapestry of Cameroon urban landscape. Adventure awaits</p>
        ...
        <p>We love hearing from our readers Connect with us on Facebook to stay updated on our latest posts, s
          hare your own experiences, and join the conversation. Do not hesitate to reach out to us via <Link href="/contact">nzoggeivo@gmail.com</Link> if you have any questions or suggestions.</p>
